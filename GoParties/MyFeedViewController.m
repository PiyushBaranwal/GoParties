...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.row==0)
    {
       ...
       // for the myfeed comment box
        UIView *myfeedBackView=[[UIView alloc]initWithFrame:CGRectMake(5, 5, self.view.frame.size.width-10, 80)];
    ...
    //////------------------------------------------------------------
        ...
        for (int i=0; i<5; i++)
        {
            UIView *feedBackView=[[UIView alloc]initWithFrame:CGRectMake(5, 95+a, self.view.frame.size.width-10, 350)];//sets height according the feed data
            ...
            UIButton *shareBtn=[[UIButton alloc]initWithFrame:CGRectMake(280, 315, 20, 20)];//225, 315, 20, 20
            ...
            UILabel *shareLbl=[[UILabel alloc]initWithFrame:CGRectMake(305, 310, 100, 30)];//250, 310, 100, 30
            shareLbl.text=@"Share";
