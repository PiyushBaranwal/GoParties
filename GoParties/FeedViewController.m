...
- (void)viewDidLoad {
    ...
    likeCountArray=[[NSMutableArray alloc]init];
    commentsCountArray=[[NSMutableArray alloc]init];
    shareCountArray=[[NSMutableArray alloc]init];
    postTypeArray=[[NSMutableArray alloc]init];
    postTextArray=[[NSMutableArray alloc]init];
...
-(void)callingWebServiceForPostActivityORFeed
{
    ...
    if(checkConn)
    {
        ...
        urlAsString=[NSString stringWithFormat:@"%@/postactivity?access_token=133688745fb3253a0b4c3cbb3f67d444cf4b418a&to=100&from=1&userid=1",BaseURL];
        NSLog(@"%@", urlAsString);
...
- (void)connectionDidFinishLoading:(NSURLConnection *)connection
{
    ...
    postDataArray=[mainDataDict valueForKey:@"postdata"];
    NSLog(@"postDataArray=%@",postDataArray);
    likeCountArray=[postDataArray valueForKey:@"like_count"];
    commentsCountArray=[postDataArray valueForKey:@"like_count"];
    shareCountArray=[postDataArray valueForKey:@"share_count"];
    postTypeArray=[postDataArray valueForKey:@"post_type"];
    postTextArray=[postDataArray valueForKey:@"post_text"];
    postPhotoArray=[postDataArray valueForKey:@"post_photo"];
    postVideoArray=[postDataArray valueForKey:@"post_video"];
    postedAtArray=[postDataArray valueForKey:@"posted_at"];
    NSLog(@"postedAtArray=%@",postedAtArray);
    postedByDict=[postDataArray valueForKey:@"posted_by"];
     NSLog(@"postedByDict=%@",postedByDict);
    profileNameArray=[postedByDict valueForKey:@"name"];
    profileIdArray=[postedByDict valueForKey:@"id"];
    profilePicArray=[postedByDict valueForKey:@"profile_pic"];
    profileTypeArray=[postedByDict valueForKey:@"profile_type"];

    
    NSLog(@"likeCountArray=%@",likeCountArray);
    NSLog(@"commentsCountArray=%@",commentsCountArray);
    NSLog(@"shareCountArray=%@",shareCountArray);
    NSLog(@"postTypeArray=%@",postTypeArray);
    NSLog(@"postTextArray=%@",postTextArray);
    NSLog(@"postVideoArray=%@",postVideoArray);
    NSLog(@"profileNameArray=%@",profileNameArray);
    NSLog(@"profileIdArray=%@",profileIdArray);
