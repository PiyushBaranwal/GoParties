...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.row==0)
    {
        ...
        // for first back view ---------------------------------------------------
        UIView *fBackView=[[UIView alloc]initWithFrame:CGRectMake(5, 5, self.view.frame.size.width-10, 100)];
        fBackView.backgroundColor=[UIColor whiteColor];
        [cell1.contentView addSubview:fBackView];
        
        // for name label
        UILabel *nameLbl=[[UILabel alloc]initWithFrame:CGRectMake(5, 10, self.view.frame.size.width-30, 30)];
        nameLbl.text=@"Name:";
        nameLbl.textColor=[UIColor grayColor];
        [fBackView addSubview:nameLbl];
        //for nameTextField;
        UITextField *nameTextField=[[UITextField alloc]initWithFrame:CGRectMake(100, 10, 255, 30)];//100, 10, 200, 30
        ...
        // for type label
        UILabel *typeLbl=[[UILabel alloc]initWithFrame:CGRectMake(5, 60, self.view.frame.size.width-30, 30)];
        typeLbl.text=@"Type:";
        typeLbl.textColor=[UIColor grayColor];
        [fBackView addSubview:typeLbl];
        //for nameTextField;
        UITextField *typeTextField=[[UITextField alloc]initWithFrame:CGRectMake(100, 60, 255, 30)];//100, 60, 200, 30
        typeTextField.backgroundColor=[UIColor lightGrayColor];
        [fBackView addSubview:typeTextField];
        /////////--------------------------------------------------
        
        // for second back view ---------------------------------------------------
        UIView *sBackView=[[UIView alloc]initWithFrame:CGRectMake(5, 110, self.view.frame.size.width-10, 100)];
        sBackView.backgroundColor=[UIColor whiteColor];
        [cell1.contentView addSubview:sBackView];
        
        // for name label
        UILabel *mobileLbl=[[UILabel alloc]initWithFrame:CGRectMake(5, 10, self.view.frame.size.width-30, 30)];
        mobileLbl.text=@"Mobile:";
        mobileLbl.textColor=[UIColor grayColor];
        [sBackView addSubview:mobileLbl];
        //for nameTextField;
        UITextField *mobileTextField=[[UITextField alloc]initWithFrame:CGRectMake(100, 10, 255, 30)];//100, 10, 200, 30
        mobileTextField.backgroundColor=[UIColor lightGrayColor];
        [sBackView addSubview:mobileTextField];
        
        //for saperator line
        UILabel *sepLbl2=[[UILabel alloc]initWithFrame:CGRectMake(0, 50, self.view.frame.size.width-10, 1)];
        ...
        // for type label
        UILabel *addLbl=[[UILabel alloc]initWithFrame:CGRectMake(5, 60, self.view.frame.size.width-30, 30)];
        addLbl.text=@"Address:";
        addLbl.textColor=[UIColor grayColor];
        [sBackView addSubview:addLbl];
        //for nameTextField;
        UITextField *addTextField=[[UITextField alloc]initWithFrame:CGRectMake(100, 60, 255, 30)];//100, 60, 200, 30
        addTextField.backgroundColor=[UIColor lightGrayColor];
        [sBackView addSubview:addTextField];
        /////////--------------------------------------------------
        
        // for Third back view ---------------------------------------------------
        UIView *tBackView=[[UIView alloc]initWithFrame:CGRectMake(5, 215, self.view.frame.size.width-10, 300)];
        tBackView.backgroundColor=[UIColor whiteColor];
        [cell1.contentView addSubview:tBackView];
        
        // for name label
        UILabel *aboutLbl=[[UILabel alloc]initWithFrame:CGRectMake(5, 10, self.view.frame.size.width-30, 30)];
        aboutLbl.text=@"About:";
        aboutLbl.textColor=[UIColor grayColor];
        [tBackView addSubview:aboutLbl];
        //for nameTextField;
        UITextField *aboutTextField=[[UITextField alloc]initWithFrame:CGRectMake(100, 10, 255, 30)];//100, 10, 200, 30
        aboutTextField.backgroundColor=[UIColor lightGrayColor];
        [tBackView addSubview:aboutTextField];
        
        //for saperator line
        UILabel *sepLbl3=[[UILabel alloc]initWithFrame:CGRectMake(0, 50, self.view.frame.size.width-10, 1)];
        ...
        // for type label
        UILabel *desLbl=[[UILabel alloc]initWithFrame:CGRectMake(5, 60, self.view.frame.size.width-30, 30)];
        desLbl.text=@"Description:";
        desLbl.textColor=[UIColor grayColor];
        [tBackView addSubview:desLbl];
        //for nameTextField;
        UITextView *desTextView=[[UITextView alloc]initWithFrame:CGRectMake(5, 90, self.view.frame.size.width-20, 205)];
        ...
        UIView *frBackView=[[UIView alloc]initWithFrame:CGRectMake(5, 520, self.view.frame.size.width-10, 60)];
        ...
        //for saperator line
        UILabel *sepLbl4=[[UILabel alloc]initWithFrame:CGRectMake(178, 0, 1, 60)];//150, 0, 1, 60
        sepLbl4.backgroundColor=[UIColor lightGrayColor];
        [frBackView addSubview:sepLbl4];
        
        //for webSite btn
        UIButton *webBtn=[[UIButton alloc]initWithFrame:CGRectMake(215, 15, 30, 30)];//160, 15, 30, 30
        ...
        // for type label
        UILabel *webLbl=[[UILabel alloc]initWithFrame:CGRectMake(250, 15, 120, 30)];//195, 15, 120, 30
