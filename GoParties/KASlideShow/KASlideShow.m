...
///////////////////---------------------------------------------------------------------------------------------------
-(void)addImagesFromURLs:(NSArray *) arrays SelectedPosition:(int)position
{
    SDWebImageManager *manager = [SDWebImageManager sharedManager];
    
    for (int i=0; i<arrays.count; i++)
    {
        [manager downloadImageWithURL:[arrays objectAtIndex:i]
                              options:0
...
-(void)addImagesFromURLs:(NSArray *) arrays
{
    
//    [self addImage:[UIImage imageWithData:[NSData dataWithContentsOfURL:[NSURL URLWithString:[arrays objectAtIndex:0]]]]];
////    [_topImageView sd_setImageWithURL:[NSURL URLWithString:[arrays objectAtIndex:0]]
...
//            {
//                [self addImage:[UIImage imageWithData:[NSData dataWithContentsOfURL:[NSURL URLWithString:[arrays objectAtIndex:i]]]]];
//                [self start];
//           }
//            
//        });
//    });
   ...
   // [globalArray arrayByAddingObjectsFromArray:arrays];
...
- (void) emptyAndAddImagesFromResources:(NSArray *)names
{
   ...
   // [self addImagesFromURLs:names];
}

- (void) emptyAndAddImages:(NSArray *)images1
{
    [self.images removeAllObjects];
    _currentIndex = 0;
    for (UIImage *image in images1){
        [self addImage:image];
    }
}
